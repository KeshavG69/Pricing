# GSA Company Repository - Implementation Plan
...
1. Admin goes to Company Repository page
...
### New Router: `/api/company-repository`
...
**Files to create:**
- `backend/models/company_repository.py` - Pydantic models
- `backend/utils/company_repository.py` - CRUD functions

**Tasks:**
- [ ] Create `CompanyRepository` Pydantic model
- [ ] Create `LaborCategory` Pydantic model
- [ ] Create `CompanyRepositoryCRUD` class
...
**Files to create:**
- `backend/routers/company_repository.py` - Router with upload endpoint
...
**Files to modify:**
- `backend/routers/company_repository.py` - Add more endpoints
...
| `backend/models/company_repository.py` | Pydantic models |
| `backend/utils/company_repository.py` | CRUD functions |
| `backend/routers/company_repository.py` | API endpoints |
...
| File | Changes |
|------|---------|
| `backend/app/server.py` | Register company_repository router |
| `backend/routers/proposals.py` | Add wage_source parameter |
| `backend/utils/pipeline.py` | Add GSA processing path |
...
- [ h] Error shown if proposal exceeds contract years
